...
class MetodoIntegralAjustador:
    ...
    def ajustar_modelo(data_cinetica, columna_tiempo, columna_concentracion_reactivo_limitante, estimacion_inicial_k, n, estimacion_inicial_A0=None):
        ...
        #(data_cinetica, columna_tiempo, columna_concentracion_reactivo_limitante, estimacion_inicial_k, n_orden, estimacion_inicial_A0=None):
    @staticmethod
    def ajustar_modelo_bimolecular(data_cinetica, columna_tiempo, columna_conversion, estimacion_inicial_k, n,estimacion_inicial_m, coeficiente_a, coeficiente_b, data_auxiliar):
        ...
        def resolver_ode(params, t, X0):
            k, m = params
            X_sol = odeint(modelo_bimolecular, X0, t, args=(k, m), atol=1e-8, rtol=1e-8)
        ...
        ax.scatter(t_data, A_concentracion, label='Datos experimentales', color='blue')
        ...
        return k_optimo, A0, m_optimo, 'modelo_bimolecular', ecuacion_texto, ecuacion_texto_cadena, ruta_imagen
